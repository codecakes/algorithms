...
var
    ...
    greaterChild = function greaterChild (Node) {
        // for maxHeap
        return Node.rightChild.val > Node.leftChild.val ? Node.rightChild:Node.leftChild;
    },
    ...
    sinkDown: function sinkDown (key) {
        ...
        while ( sinkDownComparator(tempNode, greaterNode) && !!greaterNode ) {
            heapSwap(this._arr, tempNode, greaterNode);
            key = tempNode.key;
            tempNode = this._arr[key],
            greaterNode = greaterChild(tempNode);
        }
